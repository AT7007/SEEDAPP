...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.onDeviceReady = function () {
        ...
        navigator.geolocation.watchPosition(function (position) {
            console.log(_this);
            _this.para.Latitude = position.coords.latitude;
            _this.para.Longitude = position.coords.longitude;
            _this.para.Altitude = position.coords.altitude;
            _this.para.Accuracy = position.coords.accuracy;
            _this.para.Heading = position.coords.heading;
    ...
    //
    AppComponent.prototype.onSuccess = function (position) {
        console.log(this);
